...
const RestaurantCard = ({ resData }) => {
  ...
  return (
    <div className="h-auto sm:h-[450px] p-2 sm:p-4 hover:scale-95 transition-all duration-200">
      <div className="relative bg-white rounded-2xl shadow-sm hover:shadow-md h-full flex flex-col">
        <div className="relative h-[120px] sm:h-[200px]">
          <img
        ...
        <div className="p-2 sm:p-4 flex-grow flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-sm sm:text-xl mb-1 sm:mb-2 truncate text-gray-800">
              {name}
            </h3>
            ...
            <div className="flex items-center justify-between mb-2 sm:mb-3">
              <span
                className={`px-1 sm:px-2 py-0.5 sm:py-1 rounded-lg text-xs sm:text-sm font-medium ${
                  avgRating >= 4.0
              ...
              {aggregatedDiscountInfoV3?.header && (
                <span className="text-xs sm:text-sm font-medium text-orange-500 flex items-center gap-1">
                  <svg
          ...
          <div className="flex flex-wrap items-center justify-between gap-1 sm:gap-2 pt-1 sm:pt-2 border-t border-gray-100">
