...
const RestrourantCard = (props) => {
  ...
  return (
    ...
    <div className="w-[280px] h-[350px] p-2 rounded-lg overflow-hidden bg-pink-300 my-1 ml-5 px-2">
      ...
      {/* if we doesnt destructure then h3 should look like this {props.resName} */}
      <h4 className="my-1">{cuisines.join(", ")}</h4>{" "}
      {/* Array join JavaScript(used for comma between arrays) */}
...
export const withPromotedLabel = (RestrourantCard) => {
  // It is a Higher Order Component. Which returns
  return (props) => {
    // A component & this Compo. is a fn. which
    return (
      // Simply returns Some piece of JSX code
      <div>
...
//   return (
//     // <div className="w-[250px] p-2 bg-pink-300 m-2">
//     <div className="w-full sm:w-[280px] h-[350px] p-2 rounded-lg overflow-hidden bg-pink-300 my-1 mx-auto">
//       <img
//         // className="card-img w-56 h-52 rounded-lg"
//         className="w-full h-[150px] object-cover rounded-lg"
//         alt="food"
